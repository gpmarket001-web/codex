# AGENTS.md - Cerebro Operacional da Operacao
...
- Querem se vestir bem sem esforco
- Valorizam conforto, elegancia e praticidade
- Buscam pecas com bom caimento
- Preferem comunicacao clara e segura
- Tem medo de golpe, atraso, produto ruim ou loja falsa
- Querem saber se a peca chega, se tem troca e se a loja e confiavel
- Gostam de fotos limpas, produto bem apresentado e visual premium
- Compram quando sentem desejo, seguranca e oportunidade real

A comunicacao deve respeitar esse publico: nada infantil, nada vulgar, nada agressivo, nada exagerado.
...
- Seguro, nao desesperado
- Simples, sem parecer robotico
...
- Linguagem que ataque inseguranca corporal
...
Produto + Beneficio + Seguranca + Oferta
...
## 11. Direcao criativa validada

Criativos sem texto:

- Fundo monocromatico clean
- Tons marfim, bege claro, off-white, areia, nude quente, cinza claro ou terracota suave
- Modelo adulta, preferencialmente 35+
- Pose natural andando, sentada ou em movimento leve
- Tecido com movimento
- Corpo inteiro quando possivel
- Bastante respiro visual
- Iluminacao suave de estudio
- Produto como protagonista
- Estetica editorial premium
- Sem poluicao visual
- Sem texto quando o objetivo for percepcao premium
...
10 a 15 opcoes, respeitando limite.

### Titulos longos

5 opcoes, ate 90 caracteres.
...
Indicar a melhor combinacao para teste inicial.
...
- Mobile-first
- Layout clean
- Beneficio antes da descricao tecnica
- CTA claro
...
- Envio com rastreio
- Suporte dedicado
- Pagina institucional quando existir
...
### Pedido pendente ha 1 hora

Foco: lembrete leve.

### Pedido pendente ha 6 horas

Foco: seguranca e beneficio.
